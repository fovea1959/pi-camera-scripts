...
ffmpeg -y -pattern_type glob -i "resized/*.png" -c:v mpeg4 -vtag xvid -q:v 3 resized_movie_xvid_qv3_suse.avi 

ffmpeg -y -pattern_type glob -i "resized/*.png" -c:v mpeg4 -vtag xvid -q:v 5 resized_movie_xvid_qv5_suse.avi 
